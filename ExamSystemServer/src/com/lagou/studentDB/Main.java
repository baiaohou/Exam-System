        ...
        label : while (true) {
            switch (Controller.getRequest()) {
                case 1: // add
                    ...
                    if (StudentDB.addStudent(addStudent)) {
//                        System.out.println("Add success!");
                ...
                case 2: // delete
                    ...
                    if (StudentDB.deleteStudent(delStudent)) {
//                        System.out.println("Delete success!");
                ...
                case 3: // modify
                    ...
                    if (!StudentDB.searchStudent(old)) {
                    ...
                    StudentDB.modifyStudent(old, curr);
//                    System.out.println("Modify student success!");
                ...
                case 4: // search
                    ...
                    if (StudentDB.searchStudent(searchStudent)) {
